...
<head>
    ...
    <title>Auto-Fixer Individual | Login</title>
...
CAR DIAGNOSIS</h1>
            ...
            <div class="fxt-form-content">
                <div class="fxt-page-switcher">
                    <h2 class="fxt-page-title mr-3">Individual-Login</h2>
                ...
                @endif
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="fxt-switcher-description">Don't have an account?<a href="{{ route('individual.register') }}" class="fxt-switcher-text ms-1">Register</a></div>
                    </div>
                </div>
            </div>
        </div>
