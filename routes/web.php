...
Route::match(['get', 'post'], '/blog/view', [BlogController::class, 'viewBlog'])->name('viewBlog');
Route::get('view-blogs', [BlogController::class, 'viewblogs'] )->name('users.blog.get');
...
Route::post('/comment', [BlogController::class, 'postComment'])->name('comment');
