        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Post Blog</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        <div class="col-xl-9 mx-auto">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        <label for="validationCustom01" class="form-label" style="color: black; font-style:bold">Blog Post</label>
                ...
                <div align="center">
                        <button style="width: 300px" class="btn btn-primary" type="submit">Post</button>
                    </div>
                    <br>
                    <br>
            </div>
